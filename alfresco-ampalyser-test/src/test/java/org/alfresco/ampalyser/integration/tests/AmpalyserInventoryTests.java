...
public class AmpalyserInventoryTests
{
        ...
        @BeforeTest public void executeCommand()
        {
        ...
        @Test public void jsonReportExists()
        {
